    ...
    do
    {
        ...
        case 8:
            if (array_exist == true)
            {
                ...
                insertion_sort(array_copy_3, size);
                clock_t end_insertion = clock();
                time_insertion += (double)(end_insertion - begin_insertion) / CLOCKS_PER_SEC;
