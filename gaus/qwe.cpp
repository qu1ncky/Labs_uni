...
int main()
{
    ...
    int k = 0;                    // алгоритм в тетрди неверный при нулевом столбце?
    ...
    {
        // проверка на существавания решений
        ...
        if (solutionExist)
        {
            ...
            cout << "* 1-й столбец матрицы - частное решение, все матрица - ответ в общем виде \nОтвет: " << endl;
            output(matrSolution, col, flags + 1);
